      ...
      <div className="py-10 px-10 ">
        <div className="py-5 px-8 border-double border-4 border-[#dc3444] grid grid-cols-1 md:grid-cols-3  gap-4 text-white leading-6">
          <div className='flex flex-col gap-5 ' data-aos="fade-down"
            ...
            <div className="flex flex-shrink-0 items-center border-bottom  flex-row-reverse border-h3-footer ">
              <Image src={logo}
                alt="logo"
                width={50}
                height={10}
              />
              <h3 className="ps-2 text-2xl drop-shadow-[2px_2px_3px_rgba(0,0,0,0.3)] text-[#dc3444] ">
                سئوگرام</h3>
            </div>
