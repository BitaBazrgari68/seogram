...
const Followme = () => {
    return (
        <div>
            <div className="mt-3 w-full pb-5 overflow-hidden bg-blue-700 flex flex-row-reverse justify-between items-center 
        bg-gradient-to-l dark:text-white transition-all from-white dark:from-cnDarkBlue-20 to-white/30
        ">
                <div className="  pb-6 pt-18 px-6 sm:p-10 animate-fadeleft
